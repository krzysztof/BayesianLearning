...
from utilities import max_based, LEAKDEF
...
#	nums = [1000, 2000, 3000, 4000, 1100, 1200, 1300, 1400, 1500, 1600, 1800, 1900, 800, 2500, 2400, 2300, 2200, 2100, 3100, 3300, 3500, 3700, 3900]
	...
	make_boxplot(data, labels, boxColors, boxNames, title="Euclidian distance for network %d"%(network,))
